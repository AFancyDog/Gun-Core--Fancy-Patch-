...
execute store result score player_current_armor gbg.temp run attribute @s armor get
scoreboard players operation lower_x gbg.temp = player_current_armor gbg.temp
scoreboard players operation upper_x gbg.temp = player_current_armor gbg.temp
