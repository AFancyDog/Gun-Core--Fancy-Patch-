...
execute if score @s gbg.temp matches 50 run title @s actionbar ["",{"text":"[","color":"gray"},{"text":"||||||||||||||||||||||||||||||||||||||||||||||||||","color":"red"},{"text":"]","color":"gray"}]
...
execute if score @s gbg.temp matches 1 run title @s actionbar ["",{"text":"[","color":"gray"},{"text":"|","color":"red"},{"text":"|||||||||||||||||||||||||||||||||||||||||||||||||","color":"dark_gray"},{"text":"]","color":"gray"}]
execute if score @s gbg.temp matches 0 run title @s actionbar ["",{"text":"[","color":"gray"},{"text":"||||||||||||||||||||||||||||||||||||||||||||||||||","color":"dark_gray"},{"text":"]","color":"gray"}]

#must be at end
scoreboard players reset @s[scores={gbg.cooldown=..0,gbg.reloading_time=1..}] gbg.reloading_time
