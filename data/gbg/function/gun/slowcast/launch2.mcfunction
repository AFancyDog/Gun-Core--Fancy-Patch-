...
execute store result score gbg.projectile_speed gbg.temp run data get entity @p[tag=gbg.gun_shooter] SelectedItem.components.minecraft:custom_data.gbg.projectile_speed
