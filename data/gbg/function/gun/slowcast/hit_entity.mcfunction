...
execute store result storage gbg:macro input.damage int 1 run scoreboard players get @e[type=marker,tag=gbg.slowcast,sort=nearest,limit=1] gbg.slowcast.damage
