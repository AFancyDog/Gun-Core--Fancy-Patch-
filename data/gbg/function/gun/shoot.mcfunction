#this function is used for crossbow guns as well as red dye guns
...
execute unless score gbg.max_ammo gbg.temp matches ..0 run execute store result score gbg.reload_speed gbg.temp run data get entity @s SelectedItem.components.minecraft:custom_data.gbg.reload_speed
execute unless score gbg.max_ammo gbg.temp matches ..0 if score @s player_config.gbg.desc_style matches 0 run item modify entity @s weapon.mainhand gbg:gun_lore_style/reg/default
execute unless score gbg.max_ammo gbg.temp matches ..0 if score @s player_config.gbg.desc_style matches 1 run item modify entity @s weapon.mainhand gbg:gun_lore_style/reg/fairy
execute unless score gbg.max_ammo gbg.temp matches ..0 if score @s player_config.gbg.desc_style matches 2 run item modify entity @s weapon.mainhand gbg:gun_lore_style/reg/fire
execute unless score gbg.max_ammo gbg.temp matches ..0 if score @s player_config.gbg.desc_style matches 3 run item modify entity @s weapon.mainhand gbg:gun_lore_style/reg/kelp
execute if score gbg.max_ammo gbg.temp matches ..0 if score @s player_config.gbg.desc_style matches 0 run item modify entity @s weapon.mainhand gbg:gun_lore_style/ammoless/default
execute if score gbg.max_ammo gbg.temp matches ..0 if score @s player_config.gbg.desc_style matches 1 run item modify entity @s weapon.mainhand gbg:gun_lore_style/ammoless/fairy
execute if score gbg.max_ammo gbg.temp matches ..0 if score @s player_config.gbg.desc_style matches 2 run item modify entity @s weapon.mainhand gbg:gun_lore_style/ammoless/fire
execute if score gbg.max_ammo gbg.temp matches ..0 if score @s player_config.gbg.desc_style matches 3 run item modify entity @s weapon.mainhand gbg:gun_lore_style/ammoless/kelp
...
execute if score gbg.projectile_type gbg.temp matches 100..199 run function gbg:gun/slowcast/launch
#CUSTOM PROJECTILES
execute if score gbg.projectile_type gbg.temp matches 200.. run function #gbg:projectile_type
